...
Special thanks to quickbits910 for BazziteLGTV (https://github.com/quickbits910/BazziteLGTV). It provided the original inspiration and groundwork around lightweight LG webOS control on Linux.
